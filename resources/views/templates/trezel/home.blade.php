    ...
    <div class="wrapper dark-wrapper" style="direction: ltr !important;">
      <div class="rev_slider_wrapper fullwidth-container">
        <div id="slider2" class="rev_slider fullwidthbanner" data-version="5.4.7">
          <ul>
            <li data-transition="fade" data-thumb=""><img src="{{ getImage('assets/images/frontend/hero/' . @$hero->data_values->image, '633x539') }}" alt="" />
              ...
              <a class="ml-4 tp-caption btn btn-green btn-strong-hover scroll" 
	               ...
	               data-responsive="on" 
	               data-responsive_offset="on" style="z-index: 9;" href="{{route('contact')}}">@lang('Contact Us')
	          </a>
			  <!-- /.tp-caption -->
            </li>
          </ul>
                    ...
                    <div class="row isotope">
                        ...
                        <div class="item item-detailed grid-sizer col-md-6 col-lg-4">
                            ...
                            <div class="post-content">
                                <h2 class="post-title mb-10"><a href="{{ getImage('assets/images/project/' . @$project->images[0]->filename) }}">{{$project->title}}</a></h2>
